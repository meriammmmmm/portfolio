...
export const UI = {
  en: {
    ...
    home: {
      ...
      blurb:
        "3+ years building responsive, high-performance web interfaces with React, Next.js and TypeScript.",
    ...
    home2: {
      ...
      factExperienceValue: "3+ years · 10+ projects shipped",
      factBased: "Based in",
    ...
    about: {
      ...
      cardP2d: "10+ projects",
      cardP2e:
        " across education, recruitment and business software — including a real-time collaborative document editor and Mauritania's national school platform — working in Agile/Scrum teams alongside designers, backend engineers and QA.",
      ...
      job1Note1: "7+ web platforms delivered in Agile sprints",
      job1Note2: "Reusable component libraries and shared design systems",
      job1Note3: "Performance work on data-heavy dashboards",
      job1Note4: "AI-assisted development to ship full-stack features faster",
      job2Period: "2022 — 2023",
      job2Title: "Full-Stack Developer Intern",
      job2Org: "Softylines · Sousse, Tunisia",
      job2Note1: "Trained across the full stack on live client work",
      job2Note2: "Then specialised in frontend",
      job3Period: "2022 — 2025",
      job3Title: "Bachelor's Degree in Digital Technologies",
      job3Org: "Horizon School of Digital Technologies · Sousse",
    },
  ...
  fr: {
    ...
    home: {
      ...
      blurb:
        "Plus de 3 ans à concevoir des interfaces web responsives et performantes avec React, Next.js et TypeScript.",
    ...
    home2: {
      ...
      factExperienceValue: "3+ ans · 10+ projets livrés",
      factBased: "Basée à",
    ...
    about: {
      ...
      cardP2b: "Softylines",
      cardP2c: " j'ai livré ",
      cardP2d: "plus de 10 projets",
      cardP2e:
        " dans l'éducation, le recrutement et les logiciels métier — dont un éditeur de documents collaboratif en temps réel et la plateforme scolaire nationale de Mauritanie — en équipe Agile/Scrum aux côtés de designers, développeurs back-end et QA.",
      ...
      job1Period: "2023 — aujourd'hui",
      job1Title: "Développeuse front-end",
      job1Org: "Softylines · Sousse, Tunisie",
      job1Note1: "Plus de 7 plateformes web livrées en sprints Agile",
      job1Note2:
        "Bibliothèques de composants réutilisables et design systems partagés",
      job1Note3:
        "Optimisation des performances sur des tableaux de bord à forte densité de données",
      job1Note4:
        "Développement assisté par IA pour livrer plus vite des fonctionnalités full-stack",
      job2Period: "2022 — 2023",
      job2Title: "Stage développeuse full-stack",
      job2Org: "Softylines · Sousse, Tunisie",
      job2Note1: "Formation sur toute la stack, sur des projets clients réels",
      job2Note2: "Puis spécialisation en front-end",
      job3Period: "2022 — 2025",
      job3Title: "Licence en technologies numériques",
      job3Org: "Horizon School of Digital Technologies · Sousse",
    },
  ...
  ar: {
    ...
    home: {
      ...
      blurb:
        "أكثر من 3 سنوات في بناء واجهات ويب متجاوبة وعالية الأداء باستخدام React وNext.js وTypeScript.",
    ...
    home2: {
      ...
      factExperienceValue: "أكثر من 3 سنوات · أكثر من 10 مشاريع منجزة",
    ...
    about: {
      ...
      cardP2b: "Softylines",
      cardP2c: " أنجزت ",
      cardP2d: "أكثر من 10 مشاريع",
      cardP2e:
        " في التعليم والتوظيف وبرمجيات الأعمال — منها محرّر مستندات تشاركي في الوقت الفعلي والمنصة المدرسية الوطنية في موريتانيا — ضمن فرق Agile/Scrum إلى جانب المصمّمين ومطوّري الخوادم وفرق الجودة.",
      ...
      job1Period: "2023 — حتى الآن",
      job1Title: "مطوّرة واجهات أمامية",
      job1Org: "Softylines · سوسة، تونس",
      job1Note1: "أكثر من 7 منصات ويب سُلّمت ضمن دورات Agile",
      job1Note2: "مكتبات مكوّنات قابلة لإعادة الاستخدام وأنظمة تصميم مشتركة",
      job1Note3: "تحسين الأداء على لوحات تحكم كثيفة البيانات",
      job1Note4: "تطوير مدعوم بالذكاء الاصطناعي لتسليم ميزات متكاملة بسرعة أكبر",
      job2Period: "2022 — 2023",
      job2Title: "تدريب مطوّرة متكاملة",
      job2Org: "Softylines · سوسة، تونس",
      job2Note1: "تدريب على كامل الستاك ضمن مشاريع عملاء حقيقية",
      job2Note2: "ثم التخصّص في الواجهات الأمامية",
      job3Period: "2022 — 2025",
      job3Title: "إجازة في التقنيات الرقمية",
      job3Org: "Horizon School of Digital Technologies · سوسة",
    },
